  ...
  methods: {
    ...
    handleTable(data){
      ...
      if(this.curBtnType == 'delete'){
        this.curDialogText = '确认删除该用户吗？';
      }else{
        this.curDialogText = '确认禁用该用户吗？'
      }
    },
    // 提示框确定按钮操作
    submitDialog() {
      ...
      }else if(self.curBtnType == 'disabled'){
        // 禁用按钮
        self.cusDialog.isShow = false;
